/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2117f23c433a3a0295a83497409060f6)
// Runtime types generated with workerd@1.20260205.0 2025-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Wisp";
	}
	interface Env {
		AI: Ai;
		CF_API_TOKEN: string;
		...
		ADMIN_DID: string;
		MODEL: string;
		WISP: DurableObjectNamespace<import("./src/index").Wisp>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_API_TOKEN" | "CF_ACCOUNT_ID" | "CF_AIG_GATEWAY_ID" | "BSKY_HANDLE" | "BSKY_PDS" | "BSKY_PASSWORD" | "ADMIN_DID" | "MODEL">> {}
}
